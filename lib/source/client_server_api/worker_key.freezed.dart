...
mixin _$WorkerKey {
  ...
  @JsonKey(ignore: true)
  $WorkerKeyCopyWith<WorkerKey> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $WorkerKeyCopyWith<$Res> {
  factory $WorkerKeyCopyWith(WorkerKey value, $Res Function(WorkerKey) then) =
      _$WorkerKeyCopyWithImpl<$Res>;
  $Res call(
      {String app,
      String name,
      String api_key,
...
/// @nodoc
class _$WorkerKeyCopyWithImpl<$Res> implements $WorkerKeyCopyWith<$Res> {
  _$WorkerKeyCopyWithImpl(this._value, this._then);

  final WorkerKey _value;
  // ignore: unused_field
  final $Res Function(WorkerKey) _then;
    ...
    return _then(_value.copyWith(
      ...
      api_key: api_key == freezed
          ...
          : api_key // ignore: cast_nullable_to_non_nullable
              as String,
      worker_dep_id: worker_dep_id == freezed
          ? _value.worker_dep_id
          : worker_dep_id // ignore: cast_nullable_to_non_nullable
              as int,
      dep: dep == freezed
          ? _value.dep
...
class _$_WorkerKey extends _WorkerKey with DiagnosticableTreeMixin {
  ...
  factory _$_WorkerKey.fromJson(Map<String, dynamic> json) =>
