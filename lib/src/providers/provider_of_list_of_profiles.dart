...
final workerProfiles =
    StateNotifierProvider<_ProviderOfListOfProfiles, List<WorkerProfile>>(
  (ref) {
    return _ProviderOfListOfProfiles(ref);
  },
);

class _ProviderOfListOfProfiles extends StateNotifier<List<WorkerProfile>> {
  _ProviderOfListOfProfiles(this.ref) // , List<WorkerKey> wKeys
      : super(<WorkerProfile>[]) {
